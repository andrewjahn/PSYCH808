...
spm_dir = which('spm');
spm_filepath = fileparts(spm_dir);
...
if isfile([pwd '/sub-' subject '/func/sub-' subject '_task-flanker_run-1_bold.nii']) == 0
    display('Run 1 has not been unzipped; unzipping now')
    gunzip([pwd '/sub-' subject '/func/sub-' subject '_task-flanker_run-1_bold.nii.gz'])
else
    display('Run 1 is already unzipped; doing nothing')
end

if isfile([pwd '/sub-' subject '/func/sub-' subject '_task-flanker_run-2_bold.nii']) == 0
    display('Run 2 has not been unzipped; unzipping now')
    gunzip([pwd '/sub-' subject '/func/sub-' subject '_task-flanker_run-2_bold.nii.gz'])
else
    display('Run 2 is already unzipped; doing nothing')
end

if isfile([pwd '/sub-' subject '/anat/sub-' subject '_T1w.nii']) == 0
    display('Anatomical image has not been unzipped; unzipping now')
    gunzip([pwd '/sub-' subject '/anat/sub-' subject '_T1w.nii.gz'])
else
...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {
                                                                     {[pwd '/sub-' subject '/func/sub-' subject '_task-flanker_run-1_bold.nii']}
                                                                     {[pwd '/sub-' subject '/func/sub-' subject '_task-flanker_run-2_bold.nii']}
                                                                     }';
...
matlabbatch{4}.spm.spatial.coreg.estwrite.source = {[pwd '/sub-' subject '/anat/sub-' subject '_T1w.nii,1']};
...
matlabbatch{5}.spm.spatial.preproc.channel.vols = {[pwd '/sub-' subject '/anat/rsub-' subject '_T1w.nii,1']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(1).tpm = {[spm_filepath '/tpm/TPM.nii,1']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(2).tpm = {[spm_filepath '/tpm/TPM.nii,2']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(3).tpm = {[spm_filepath '/tpm/TPM.nii,3']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(4).tpm = {[spm_filepath '/tpm/TPM.nii,4']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(5).tpm = {[spm_filepath '/tpm/TPM.nii,5']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(6).tpm = {[spm_filepath '/tpm/TPM.nii,6']};
...
matlabbatch{9}.spm.stats.fmri_spec.dir = {[pwd '/sub-' subject '/1stLevel']};
...
data_incongruent_run1 = load([pwd '/sub-' subject '/func/incongruent_run1.txt']);
...
data_congruent_run1 = load([pwd '/sub-' subject '/func/congruent_run1.txt']);
...
%%
data_incongruent_run2 = load([pwd '/sub-' subject '/func/incongruent_run2.txt']);
...
%%
data_congruent_run2 = load([pwd '/sub-' subject '/func/congruent_run2.txt']);
